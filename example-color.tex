...
\schoolname{\hspace{5.8em} 西南石油大学}%学校名称
\membera{\hspace{6em} 廖存燕} %队员A
\memberb{\hspace{6em} 容斌元} %队员B
\memberc{\hspace{6em} 何坤} %队员C
...
\begin{figure}[htp!]
\centering
\includegraphics[width=.55\textwidth]{1.png}
\caption{算法流程图}
\end{figure}
